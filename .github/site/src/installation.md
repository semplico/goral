...
<details>
  <summary>or by downloading a prebuilt binary from <a href="https://github.com/semplico/goral/releases" target="_blank">the releases page</a> manually
</summary>

```sh
wget https://github.com/semplico/goral/releases/download/0.1.18/goral-0.1.18-x86_64-unknown-linux-gnu.tar.gz
tar -xzf goral-0.1.18-x86_64-unknown-linux-gnu.tar.gz
cd goral-0.1.18-x86_64-unknown-linux-gnu/
...
git clone --depth 1 https://github.com/semplico/goral
cd goral
