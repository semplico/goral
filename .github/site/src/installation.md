...
```sh
wget https://github.com/maksimryndin/goral/releases/download/0.1.11/goral-0.1.11-x86_64-unknown-linux-gnu.tar.gz
tar -xzf goral-0.1.11-x86_64-unknown-linux-gnu.tar.gz
cd goral-0.1.11-x86_64-unknown-linux-gnu/
...
git clone --depth 1 --branch 0.1.11 https://github.com/maksimryndin/goral
cd goral
